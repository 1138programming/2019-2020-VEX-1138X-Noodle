...
class EventScheduler {
  ...
  public:
    ...
    bool commandInScheduler(Command* aCommand); // Checks if a command is in the command queue
    bool commandGroupInScheduler(CommandGroup* aCommandGroup); // Checks if a command is in the command group queue
    void initialize();
};
